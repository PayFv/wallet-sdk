...
export var ErrorMessages = (_ErrorMessages = {}, _ErrorMessages[ErrorCodes.UNKNOWN] = "Unknown error", _ErrorMessages[ErrorCodes.INSUFFICIENT_BTC_UTXO] = "Insufficient btc utxo", _ErrorMessages[ErrorCodes.INSUFFICIENT_ASSET_UTXO] = "Insufficient asset utxo", _ErrorMessages[ErrorCodes.NOT_SAFE_UTXOS] = "Not safe utxos", _ErrorMessages[ErrorCodes.ASSET_MAYBE_LOST] = "Asset maybe lost", _ErrorMessages);
export var WalletUtilsError = /*#__PURE__*/function (_Error) {
  ...
  function WalletUtilsError(code, message) {
    ...
    _this.code = code;
    Object.setPrototypeOf(_assertThisInitialized(_this), WalletUtilsError.prototype);
    return _this;
  }

...
export var LocalWallet = /*#__PURE__*/function () {
  function LocalWallet(wif, addressType, networkType) {
  ...
  LocalWallet.fromMnemonic = function fromMnemonic(addressType, networkType, mnemonic, passPhrase, hdPath) {
    ...
    var _wallet = keyring.wallets[0];
    _wallet.network = toPsbtNetwork(networkType);
    var wallet = new LocalWallet(keyring.wallets[0].toWIF(), addressType, networkType);
    return wallet;
  };
  LocalWallet.fromRandom = function fromRandom(addressType, networkType) {
    if (addressType === void 0) {
      addressType = AddressType.P2WPKH;
    }
    if (networkType === void 0) {
    ...
    var wallet = new LocalWallet(ecpair.toWIF(), addressType, networkType);
    return wallet;
  };
  ...
  _proto.formatOptionsToSignInputs = /*#__PURE__*/function () {
    var _formatOptionsToSignInputs = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_psbt, options) {
      var _this = this;
      var accountAddress, accountPubkey, toSignInputs, networkType, psbtNetwork, psbt;
          ...
          case 3:
            ...
            if (options && options.toSignInputs) {
              ...
              toSignInputs = options.toSignInputs.map(function (input) {
                ...
                var sighashTypes = (_input$sighashTypes = input.sighashTypes) == null ? void 0 : _input$sighashTypes.map(Number);
                if (sighashTypes != null && sighashTypes.some(isNaN)) throw new Error("invalid sighash type in toSignInput");
                return {
                  index: index,
              ...
              psbt = typeof _psbt === "string" ? bitcoin.Psbt.fromHex(_psbt, {
                network: psbtNetwork
              }) : _psbt;
              psbt.data.inputs.forEach(function (v, index) {
                ...
                if (script && !isSigned) {
                  var address = scriptPkToAddress(script, _this.networkType);
  ...
  _proto.signPsbt = /*#__PURE__*/function () {
    var _signPsbt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(psbt, opts) {
      var _this2 = this;
      var _opts, _inputs;
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          ...
          case 6:
            psbt.data.inputs.forEach(function (v, index) {
              var isNotSigned = !(v.finalScriptSig || v.finalScriptWitness);
              var isP2TR = _this2.addressType === AddressType.P2TR || _this2.addressType === AddressType.M44_P2TR;
              var lostInternalPubkey = !v.tapInternalKey;
              // Special measures taken for compatibility with certain applications.
              if (isNotSigned && isP2TR && lostInternalPubkey) {
                var _v$witnessUtxo;
                var tapInternalKey = toXOnly(Buffer.from(_this2.pubkey, "hex"));
                ...
                if (((_v$witnessUtxo = v.witnessUtxo) == null ? void 0 : _v$witnessUtxo.script.toString("hex")) == (output == null ? void 0 : output.toString("hex"))) {
  ...
  _proto.getPublicKey = /*#__PURE__*/function () {
    var _getPublicKey = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3() {
      var pubkeys;
  ...
  _proto.signMessage = /*#__PURE__*/function () {
    var _signMessage = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(text, type) {
      var pubkey;
  ...
  _proto.signData = /*#__PURE__*/function () {
    var _signData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee5(data, type) {
      var pubkey;

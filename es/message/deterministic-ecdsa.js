...
noble_secp256k1.utils.hmacSha256Sync = function (key) {
  ...
  return hmac.hmac(sha256.sha256, key, (_noble_secp256k1$util = noble_secp256k1.utils).concatBytes.apply(_noble_secp256k1$util, msgs));
};
...
export function signMessageOfDeterministicECDSA(ecpair, message) {
  ...
  var _noble_secp256k1$sign = noble_secp256k1.signSync(Buffer.from(hash), ecpair.privateKey.toString("hex"), {
      canonical: true,
      recovered: true,
      der: false
    }),

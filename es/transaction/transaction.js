...
export var Transaction = /*#__PURE__*/function () {
  ...
  _proto.calNetworkFee = /*#__PURE__*/function () {
    var _calNetworkFee = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee() {
      var psbt, txSize, fee;
  ...
  _proto.createEstimatePsbt = /*#__PURE__*/function () {
    var _createEstimatePsbt = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2() {
      var estimateWallet, scriptPk, tx, psbt, toSignInputs;
      return _regeneratorRuntime.wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            estimateWallet = EstimateWallet.fromRandom(this.inputs[0].utxo.addressType, this.networkType);
            scriptPk = addressToScriptPk(estimateWallet.address, this.networkType).toString("hex");
            tx = this.clone();
  ...
  _proto.selectBtcUtxos = function selectBtcUtxos() {
    ...
    if (totalInput < totalOutput) {
      var _utxoHelper$selectBtc = utxoHelper.selectBtcUtxos(this._cacheBtcUtxos, totalOutput - totalInput),
      ...
      selectedUtxos.forEach(function (v) {
        ...
        _this2._cacheNetworkFee += utxoHelper.getAddedVirtualSize(v.addressType) * _this2.feeRate;
      });
  ...
  _proto.addSufficientUtxosForFee = /*#__PURE__*/function () {
    var _addSufficientUtxosForFee = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee3(btcUtxos, forceAsFee) {
      ...
      return _regeneratorRuntime.wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          ...
          case 8:
            ...
            dummyBtcUtxoSize = utxoHelper.getAddedVirtualSize(dummyBtcUtxo.addressType);
          ...
          case 22:
            changeAmount = this.getTotalInput() - this.getTotalOutput() - Math.ceil(this._cacheNetworkFee);
  ...
  _proto.dumpTx = /*#__PURE__*/function () {
    var _dumpTx = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee4(psbt) {
      var tx, feeRate;

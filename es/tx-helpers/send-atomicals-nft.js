...
function _sendAtomicalsNFT() {
  _sendAtomicalsNFT = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref) {
    var assetUtxo, btcUtxos, toAddress, networkType, changeAddress, feeRate, _ref$enableRBF, enableRBF, tx, toSignInputs, _toSignInputs, psbt;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          assetUtxo = _ref.assetUtxo, btcUtxos = _ref.btcUtxos, toAddress = _ref.toAddress, networkType = _ref.networkType, changeAddress = _ref.changeAddress, feeRate = _ref.feeRate, _ref$enableRBF = _ref.enableRBF, enableRBF = _ref$enableRBF === void 0 ? true : _ref$enableRBF;

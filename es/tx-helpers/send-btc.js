...
function _sendBTC() {
  _sendBTC = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref) {
    var btcUtxos, tos, networkType, changeAddress, feeRate, _ref$enableRBF, enableRBF, memo, memos, tx, toSignInputs, psbt;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          btcUtxos = _ref.btcUtxos, tos = _ref.tos, networkType = _ref.networkType, changeAddress = _ref.changeAddress, feeRate = _ref.feeRate, _ref$enableRBF = _ref.enableRBF, enableRBF = _ref$enableRBF === void 0 ? true : _ref$enableRBF, memo = _ref.memo, memos = _ref.memos;
        ...
        case 3:
          ...
          if (memo) {
            ...
            if (Buffer.from(memos[0], "hex").toString("hex") === memos[0]) {
              tx.addOpreturn(memos.map(function (memo) {
...
function _sendAllBTC() {
  _sendAllBTC = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee2(_ref2) {
    var btcUtxos, toAddress, networkType, feeRate, _ref2$enableRBF, enableRBF, tx, toSignInputs, fee, unspent, psbt;
    return _regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          btcUtxos = _ref2.btcUtxos, toAddress = _ref2.toAddress, networkType = _ref2.networkType, feeRate = _ref2.feeRate, _ref2$enableRBF = _ref2.enableRBF, enableRBF = _ref2$enableRBF === void 0 ? true : _ref2$enableRBF;
          if (!utxoHelper.hasAnyAssets(btcUtxos)) {
            _context2.next = 3;
            break;
          }

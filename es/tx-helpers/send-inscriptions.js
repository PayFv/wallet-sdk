...
function _sendInscriptions() {
  _sendInscriptions = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref) {
    var assetUtxos, btcUtxos, toAddress, networkType, changeAddress, feeRate, _ref$enableRBF, enableRBF, tx, toSignInputs, i, assetUtxo, _toSignInputs, psbt;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          assetUtxos = _ref.assetUtxos, btcUtxos = _ref.btcUtxos, toAddress = _ref.toAddress, networkType = _ref.networkType, changeAddress = _ref.changeAddress, feeRate = _ref.feeRate, _ref$enableRBF = _ref.enableRBF, enableRBF = _ref$enableRBF === void 0 ? true : _ref$enableRBF;

...
function _splitInscriptionUtxo() {
  _splitInscriptionUtxo = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(_ref) {
    var btcUtxos, assetUtxo, networkType, changeAddress, feeRate, _ref$enableRBF, enableRBF, _ref$outputValue, outputValue, tx, toSignInputs, lastUnit, splitedCount, ordUtxo, tmpOutputCounts, j, unit, _toSignInputs, psbt;
    return _regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          btcUtxos = _ref.btcUtxos, assetUtxo = _ref.assetUtxo, networkType = _ref.networkType, changeAddress = _ref.changeAddress, feeRate = _ref.feeRate, _ref$enableRBF = _ref.enableRBF, enableRBF = _ref$enableRBF === void 0 ? true : _ref$enableRBF, _ref$outputValue = _ref.outputValue, outputValue = _ref$outputValue === void 0 ? 546 : _ref$outputValue;

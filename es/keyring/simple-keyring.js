...
export var SimpleKeyring = /*#__PURE__*/function (_EventEmitter) {
      ...
      return _regeneratorRuntime.wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            return _context6.abrupt("return", signMessageOfDeterministicECDSA(keyPair, text));
          case 2:
          case "end":
  ...
  /*#__PURE__*/
  function () {
    var _signData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee8(publicKey, data, type) {
      var keyPair;
      return _regeneratorRuntime.wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            return _context8.abrupt("return", keyPair.sign(Buffer.from(data, "hex")).toString("hex"));
          case 6:
            if (!(type === "schnorr")) {
              _context8.next = 10;
              break;
            }
            return _context8.abrupt("return", keyPair.signSchnorr(Buffer.from(data, "hex")).toString("hex"));
          case 10:
  ...
  _proto.exportAccount = /*#__PURE__*/function () {
    var _exportAccount = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee9(publicKey) {
      var wallet;
      return _regeneratorRuntime.wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          case 0:
            wallet = this._getWalletForAccount(publicKey);
            return _context9.abrupt("return", wallet.privateKey.toString("hex"));
          case 2:
          case "end":
